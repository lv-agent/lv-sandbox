...
fn syscall_to_scmp(syscall: &crate::syscall::Syscall) -> Result<ScmpSyscall, String> {
    let name = match syscall {
        ...
        crate::syscall::Syscall::Bind => "bind",
        crate::syscall::Syscall::Listen => "listen",
        crate::syscall::Syscall::Accept => "accept",
        crate::syscall::Syscall::Accept4 => "accept4",
        crate::syscall::Syscall::Sendto => "sendto",
        crate::syscall::Syscall::Recvfrom => "recvfrom",
        crate::syscall::Syscall::Sendmsg => "sendmsg",
        crate::syscall::Syscall::Recvmsg => "recvmsg",
        crate::syscall::Syscall::Sendmmsg => "sendmmsg",
        crate::syscall::Syscall::Recvmmsg => "recvmmsg",
        crate::syscall::Syscall::Getsockopt => "getsockopt",
        crate::syscall::Syscall::Setsockopt => "setsockopt",
        crate::syscall::Syscall::Shutdown => "shutdown",
        crate::syscall::Syscall::Getsockname => "getsockname",
        crate::syscall::Syscall::Getpeername => "getpeername",
